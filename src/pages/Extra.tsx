...
import { vendors, documents, trainingSessions } from '../data/mockData';
...
const Extra: React.FC = () => {
  ...
  const filteredVendors = useBranchFilter(vendors);
  const filteredDocuments = useBranchFilter(documents);
  const filteredTrainingSessions = useBranchFilter(trainingSessions);
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600">{filteredDocuments.filter(doc => doc.status === 'Pending').length}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{filteredTrainingSessions.length}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{filteredVendors.filter(vendor => vendor.category === 'Fabric Supplier').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{filteredVendors.filter(vendor => vendor.category === 'Trims & Accessories').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{filteredVendors.filter(vendor => vendor.category === 'Service Provider').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600">{filteredVendors.filter(vendor => vendor.category === 'Equipment Supplier').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{filteredDocuments.filter(doc => doc.category === 'Legal').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{filteredDocuments.filter(doc => doc.category === 'Compliance').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{filteredDocuments.filter(doc => doc.category === 'Contract').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600">{filteredDocuments.filter(doc => doc.status === 'Pending Review').length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{filteredTrainingSessions.length}</p>
            </div>
